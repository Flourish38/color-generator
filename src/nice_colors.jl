...
#=
scores:
    base:           21.399246284953524
    protanopic:     10.873093430667257
    deuteranopic:   10.91228768830136
    tritanopic:     10.875518556375413
=#
...
cvd_11_contrast = parse.(RGB, ["#FD5891", "#AF5E54", "#999082", "#8D6C0A", "#8F9D00", "#61794F", "#0D7D84", "#3698F6", "#6566C8", "#AB88B7", "#EE00F2"])